...
class TorchTrainerMultiObjective(DataParallelTrainer):
    ...
    * :ref:`Hugging Face Transformers Guide <train-pytorch-transformers>`
    ...
    def __init__(
        ...
        **kwargs
        ...
        # if kwargs not empty, use it to update train_loop_config
        if kwargs:
            train_loop_config = kwargs

        print("train_loop_config: ", train_loop_config)

        super(TorchTrainerMultiObjective, self).__init__(
            train_loop_per_worker=train_loop_per_worker,
            train_loop_config=train_loop_config,
